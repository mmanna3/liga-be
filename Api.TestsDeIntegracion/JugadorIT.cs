...
public class JugadorIT : TestBase
{
    ...
    {
        var torneoOro = new Torneo { Id = 0, Nombre = $"Oro {baseId}", Anio = 2026, TorneoAgrupadorId = 1, EsVisibleEnApp = true, SeVenLosGolesEnTablaDePosiciones = true };
        var torneoPlata = new Torneo { Id = 0, Nombre = $"Plata {baseId}", Anio = 2026, TorneoAgrupadorId = 1, EsVisibleEnApp = true, SeVenLosGolesEnTablaDePosiciones = true };
