...
namespace Api.Migrations
{
    ...
    [Migration("20250403070021_AgregaKeyEnJugadorEquipoParaEquipoYJugador")]
    partial class AgregaKeyEnJugadorEquipoParaEquipoYJugador
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Api.Core.Entidades.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            NombreUsuario = "mati",
                            Password = "$2a$12$KzRpuLNKIQmw6BzenQxaFekioVGg69CIOHCvW/cj3Tbz.5rxFUCUC",
                            RolId = 1
                        },
                        new
                        {
                            Id = 2,
                            NombreUsuario = "pipa",
                            Password = "$2a$12$okGG1dbFcddqKEN3uzZHueKD8G6vj6IZRNWJbCJwC6E5QaxoWR79m",
                            RolId = 1
                        });
                });
