...
namespace Api.Migrations
{
    ...
    [Migration("20250317023940_PasswordDelDelegadoPuedeSerNull")]
    partial class PasswordDelDelegadoPuedeSerNull
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Api.Core.Entidades.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            NombreUsuario = "mati",
                            Password = "$2a$12$j5FSczH0wjmaydQHI8jkLuY4pgdUw.50sRzE6NE52kBKucQRAnrxi"
                        },
                        new
                        {
                            Id = 2,
                            NombreUsuario = "pipa",
                            Password = "$2a$12$/358f1/4/wp0Q1UCBlL0gestqCJwgt35SQ4OOtpgF3r.G2FPk858i"
                        });
                });
