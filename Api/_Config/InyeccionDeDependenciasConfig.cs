...
public static class InyeccionDeDependenciasConfig
{
    public static WebApplicationBuilder Configurar(WebApplicationBuilder builder)
    {
        ...
        builder.Services.AddScoped<IConfiguracionCore, ConfiguracionCore>();
        ...
        builder.Services.AddScoped<IArbitroJornadaRepo, ArbitroJornadaRepo>();
        builder.Services.AddScoped<IArbitroAsignacionCore, ArbitroAsignacionCore>();
